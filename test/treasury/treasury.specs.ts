...
import { RPC } from "../contants";
import { DEFAULT_ENV, NATIVE, WNATIVE } from "../../tasks/constants";
import { Treasury__factory } from "../../typechain-types/factories/contracts/assetTreasury/Treasury__factory";
...
describe("Treasury Contract", async () => {
  const setupTests = async () => {
    ...
    return {
      batchTransaction: Treasury__factory.connect(
